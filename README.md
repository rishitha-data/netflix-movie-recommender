...
The backend exposes **REST APIs using FastAPI**, which can be consumed by frontend applications.
...
1. Movie metadata such as cast, crew, genres, and keywords are combined into a single feature called **tags**.
...
4. When a movie is selected, the system returns the **Top N most similar movies**.
